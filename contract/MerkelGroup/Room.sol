 ...
 * Room is not part of the current BaseCommunity core. This file is retained
 * only to document the earlier nested-room design. See README.md in this
 * directory before using any community interface.
 */
